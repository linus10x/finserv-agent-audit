...
**License optionality (Apache 2.0 standby):** [`LICENSE-APACHE-2.0`](LICENSE-APACHE-2.0) is staged alongside the existing MIT [`LICENSE`](LICENSE) (not replacing it). Adopters whose legal review requires the Apache 2.0 §3 express patent grant can request dual-license election by opening an issue.
